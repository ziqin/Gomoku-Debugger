...
class CodeCheck:
    ...
    # Call this function and get True or False, self.error_msg has the massage
    def check_code(self):
        # check if contains forbidden library
        if not self.__check_forbidden_import():
            return False
    ...
    def __check_forbidden_import(self):
        with open(self.script_file_path, 'r', encoding='UTF-8') as myfile:
            ...
            for keyword in FORBIDDEN_LIST:
                ...
                if idx != -1:
                    self.error_msg = "import forbidden"
                    return False
        return True
    ...
    def __check_go(self, chessboard):
        ...
        try:
            ...
            self.error_msg = "Error:" + traceback.format_exc()
            return False
        return True
